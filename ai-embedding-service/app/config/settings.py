...
class Settings(BaseSettings):
    ...
    # Model Configuration
    EMBEDDING_PROVIDER: str = "local"  # compatibility flag; ignored by service
    HF_HOME: Optional[str] = None  # optional Hugging Face cache dir
    ...
    model_config = SettingsConfigDict(
        ...
        case_sensitive=True,
        extra="ignore",  # Ignore unknown env vars for compatibility
    )
